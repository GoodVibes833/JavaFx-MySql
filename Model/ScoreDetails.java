...
public class ScoreDetails {
    ...
    public ScoreDetails(int id, String first, int test1, int test2, int test3, int test4, int test5, int test6, int test7, int test8, int test9, int test10, int ave) {
    ...
    public String toString() {
        return getId() + " " + getFirst() + " " + getTest1() + " " + getTest2() + " " + getTest3() + " " + getTest4() + " " + getTest5() + " " + getTest6() + " " + getTest7() + " " + getTest8() + " " + getTest9() + " " + getTest10() + " " + getAve();
